...
public class TeamNamesBet365 implements ITeamNames {
    private HashMap<String, String> teams;
    @Override
    public void loadTeams(Db db, String league) throws SQLException {
        try {
            setTeams(db.loadTeamsForLeague(league, BettingPlaceNames.Bet365.toString()));
        }catch (SQLException e){
            System.out.println("greska pri ucitavanju lige: ("+league+") u bet365 kladionici.");
